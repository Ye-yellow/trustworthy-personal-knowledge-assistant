"""Alembic environment for the asynchronous SQLite control database."""
...
from trustworthy_kb.persistence import Base
...
def _database_url() -> str:
    ...
    return configured or DatabaseSettings().url_value
